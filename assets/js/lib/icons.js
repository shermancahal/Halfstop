 ...
 *
 * Deliberately not their trademarks: Apple's, Google's, Waze's and MapQuest's
 * logos are theirs, and shipping copies of them inside somebody else's app is
 * not ours to do. These are four plainly different silhouettes - an arrow, a
 * pin, a speech bubble, a folded map - in a colour each service is associated
 ...
 */
  ...
  /* A folded map, for MapQuest. */
  navMapquest: svg('<path d="M9 4 3 6.5v13L9 17l6 3 6-2.5v-13L15 7 9 4Z"/><path d="M9 4v13"/><path d="M15 7v13"/>'),
