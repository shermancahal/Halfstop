...
export const icons = {
  ...
  /* A phone, for "follow the device" in the theme row. */
  device: svg('<rect x="7" y="2" width="10" height="20" rx="2"/><path d="M11 18h2"/>'),
  refresh: svg('<path d="M21 12a9 9 0 1 1-2.6-6.4"/><path d="M21 3v6h-6"/>'),
  /* Into the app rather than out of it: the same door as `logout`, with the
     arrow pointing the other way and the frame on the other side. */
  login: svg('<path d="m10 17 5-5-5-5"/><path d="M15 12H3"/><path d="M13 3h5a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-5"/>'),
  /* A person with a plus, for making an account rather than opening one. */
  userPlus: svg('<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v6"/><path d="M22 11h-6"/>'),
  /* An envelope, for the things this app sends rather than shows. */
  mail: svg('<rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3.6 7.2 8.4 5.9 8.4-5.9"/>'),
  logout: svg('<path d="m15 17 5-5-5-5"/><path d="M20 12H8"/><path d="M11 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h5"/>'),
