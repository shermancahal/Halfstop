 ...
 *         --zip  also write dist/halfstop-maps.zip for hosts whose file
...
const INCLUDE_FILES = ['index.html', 'about.html', 'map.html', 'account.html', 'faq.html', 'terms.html', 'privacy.html', 'admin.html'];
...
const HTACCESS = `# Halfstop — Apache configuration
#
...
function deployNotes(fileCount, bytes) {
  return `Halfstop — upload instructions
=========================================
